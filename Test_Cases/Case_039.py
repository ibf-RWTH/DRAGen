...
Pearlite = r'./ExampleInput/Substructure/example_pag_inp.csv'
...
files = {1: None, 2: None, 3: Pearlite, 4: None, 5:None, 6: None, 7: None}  # ['Ferrite', 'Martensite', 'Pearlite', 'Bainite', 'Inclusion', 'Banding']
