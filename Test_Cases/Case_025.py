...
pbc_flag = True
submodel_flag = False
phase2iso_flag = {1:True, 2:True, 3:True, 4:True, 5:False}
x_fem_flag = False
...
files = {1: None, 2: None, 3: Pearlite, 4: None, 5:Austenite, 6: None, 7: None}  # ['Ferrite', 'Martensite', 'Pearlite', 'Bainite', 'Inclusion', 'Banding']
# Change the file name to 'None' if its empty
phase_ratio = {1: 0, 2: 0, 3: 0.5, 4: 0, 5: 0.5, 6: 0, 7:0}
