...
files = {1: Ferrite, 2: None, 3: None, 4: Bainite, 5:Austenite, 6: Inclusion, 7: None}  # ['Ferrite', 'Martensite', 'Pearlite', 'Bainite', 'Inclusion', 'Banding']
# Change the file name to 'None' if its empty
phase_ratio = {1: 0.3, 2: 0, 3: 0, 4: 0.3, 5: 0.35, 6: 0.05, 7:0}
