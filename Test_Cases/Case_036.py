...
files = {1: None, 2: None, 3: Pearlite, 4: Bainite, 5:None, 6: Inclusions, 7: None}  # ['Ferrite', 'Martensite', 'Pearlite', 'Bainite', 'Inclusion', 'Banding']
# Change the file name to 'None' if its empty
phase_ratio = {1: 0, 2: 0, 3: 0.45, 4: 0.5, 5: 0, 6: 0.05, 7:0}
