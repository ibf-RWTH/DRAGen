...
Bands = r'./ExampleInput/Ferrite/TrainedData_Ferrite.pkl'
...
files = {1: None, 2: Martensite, 3: None, 4: None, 5:None, 6: None, 7: Bands}  # ['Ferrite', 'Martensite', 'Pearlite', 'Bainite', 'Inclusion', 'Banding']
# Change the file name to 'None' if its empty
phase_ratio = {1: 0, 2: 0.80, 3: 0, 4: 0, 5: 0, 6: 0, 7: 0.2}
