...
files = {1: Ferrite, 2: Martensite, 3: Pearlite, 4: None, 5:None, 6: None, 7: Bands}  # ['Ferrite', 'Martensite', 'Pearlite', 'Bainite', 'Inclusion', 'Banding']
# Change the file name to 'None' if its empty
phase_ratio = {1: 0.3, 2: 0.3, 3: 0.3, 4: 0, 5: 0, 6: 0, 7: 0.10}
