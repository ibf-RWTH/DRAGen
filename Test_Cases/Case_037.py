...
#Inclusions
#Inclusions = r'./ExampleInput/Inclusions/TrainedData_Inclusion.pkl'
Inclusions = r'./ExampleInput/Martensite/TrainedData_Martensite.pkl'
...
pbc_flag = True
submodel_flag = False
phase2iso_flag = {1:False, 2:False, 3:False, 4:True, 5:True}
x_fem_flag = False
element_type = 'HEX8'
anim_flag = False

#Choosing active files
files = {1: Ferrite, 2: Martensite, 3: None, 4: None, 5:Austenite, 6: Inclusions, 7: None}  # ['Ferrite', 'Martensite', 'Pearlite', 'Bainite', 'Inclusion', 'Banding']
# Change the file name to 'None' if its empty
phase_ratio = {1: 0.35, 2: 0.30, 3: 0, 4: 0, 5: 0.3, 6: 0.05, 7:0}
