...
#DP800
file1 = r'C:\Nikitas\DRAGen_test/input1.csv'
...
Run(dimension=dimension, box_size=box_size, box_size_y=box_size_y, box_size_z=box_size_z, resolution=resolution,
    ...
    phase2iso_flag=phase2iso_flag, x_fem_flag=x_fem_flag, smoothing_flag=smoothing_flag, gui_flag=False, anim_flag=anim_flag,
