...
import os
from new_substructure import Grain
...
class Run():
    ...
    def run(self,rve_df,grains_df,equiv_d,p_sigma,t_mu, b_sigma,lower=None,upper=None,circularity=1,plt_name = None,save= True,plot=False,store_path = None,filename = None,fig_path = None):
        ...
        for i in range(len(grains_df)):
            ...
            if phaseID == 2:
                ...
                grain.gen_subs(equiv_d,sigma=p_sigma,block_thickness=t_mu,b_sigma=b_sigma,lower_t=lower,upper_t=upper,circularity=circularity)
...
if __name__ == '__main__':
    ...
    test_run.run(rve_data,grains_df,equiv_d=4,p_sigma=0.1,t_mu=1,b_sigma=0.1,store_path='./',plt_name=['packet','block'],plot=True,fig_path='D:/')
